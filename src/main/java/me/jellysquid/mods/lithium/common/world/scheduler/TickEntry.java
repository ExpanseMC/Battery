...
/**
 * A wrapper type for {@link TickNextTickData} which adds fields to mark the state of the tick in the scheduler's pipeline.
 */
public class TickEntry<T> extends TickNextTickData<T> {
    /**
    ...
    public TickEntry(TickNextTickData<T> tick, Set<TickEntry<T>> chunkIdx) {
