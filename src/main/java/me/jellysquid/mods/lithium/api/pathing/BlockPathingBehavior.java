...
public interface BlockPathingBehavior {
     ...
     *
     * If you were mixing into the method {@link net.minecraft.world.level.pathfinder.WalkNodeEvaluator#getBlockPathTypeRaw(BlockGetter, BlockPos)},
     ...
     * fire or cactus.)
     *
     * If you were mixing into the method {@link net.minecraft.world.level.pathfinder.WalkNodeEvaluator#checkNeighbourBlocks(BlockGetter, BlockPos.MutableBlockPos, BlockPathTypes)}, you will want to implement
